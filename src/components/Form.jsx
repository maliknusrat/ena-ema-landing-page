...
export default function () {
  return (
    <div>
      {" "}
      <div className="mt-10 bg-[#151E1B] border border-[#2A3C36] rounded-xl p-6 shadow-[0px_12px_32px_0px_#1FFFA51A]">
        <form className="flex flex-col items-center gap-4">
          <div className="w-full flex flex-col md:flex-row items-center gap-4">
            ...
            <div className="relative w-full flex-1">
              <span className="absolute left-3 top-1/2 -translate-y-1/2">
                <img
                  src="/icons/EnvelopeSimpleOpen.png"
                  alt="email"
                  className="w-4 h-4"
                />
              </span>
          ...
          <button
  type="submit"
  className="text-[12px] md:text-[16px] w-full px-6 py-3 bg-[#1FFFA5] text-[#0A0F0D] font-semibold rounded-lg 
